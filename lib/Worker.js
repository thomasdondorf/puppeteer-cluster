...
class Worker {
    ...
    async handle(task, target) {
        ...
        try {
            ...
            console.log('Error crawling ' + target.url + ' // ' + e.code + ': ' + e.message);
            target.setError(err);
        }
        ...
        try {
            ...
            console.log('Error closing page' + target.url + ': ' + e.message);
        }
        ...
        if (context) {
            try {
                ...
                console.log('Error closing context' + target.url + ': ' + e.message);
            }
        }
